 ...
 */
package com.codetribe.ca.servlet;
 ...
 * @author CodeTribe1
 */
@WebServlet(name = "TestingServlet", urlPatterns = {"/ts"})
public class TestingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDTO r = getRequest(request);
        try {
            resp = TrafficCop.processRequest(r, dataUtil, listUtil);
        } catch (Exception e) {
            ...
            log.log(Level.INFO, "CompanyServlet done, elapsed: {0} seconds");
        }
    ...
    static final Logger log = Logger.getLogger(TestingServlet.class.getSimpleName());
